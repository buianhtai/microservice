package io.loyaty.repository;

import io.loyaty.MicroserviceApp;
import io.loyaty.config.Constants;
import io.loyaty.config.audit.AuditEventConverter;
import io.loyaty.domain.PersistentAuditEvent;
...
import static io.loyaty.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
